...
export function DeckFlooring() {
  ...
  const deckMainCategories = [
    ...
    },
    {
      ...
      image: "/deck/EGO Enrich Plank Decking/teak.jpg",
    ...
    },
    {
      ...
      image: "/deck/dassoCTECH Decking/1569398997183577.png",
  ...
  return (
    <div className="">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">Premium Deck Flooring Categories</h2>
