...
export function dassoCTECH() {
  // Gallery images for dassoXTR
  const galleryImages = [
    "/deck/dassoCTECH Decking/dassoCTECH Decking (1).jpg",
    "/deck/dassoCTECH Decking/dassoCTECH Decking (2).jpg",
    "/deck/dassoCTECH Decking/dassoCTECH Decking (3).jpg",
    "/deck/dassoCTECH Decking/dassoCTECH Decking (4).jpg",
    "/deck/dassoCTECH Decking/dassoCTECH Decking (5).png",
    "/deck/dassoCTECH Decking/dassoCTECH Decking (6).png",
    "/deck/dassoCTECH Decking/dassoCTECH Decking (7).png",
  ];
